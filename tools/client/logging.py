...
class ThriveTraceback(Traceback):
    # DEP-WARN
    @group()
...
class ThriveLogRender(LogRender):
    def __call__(
        self,
        console: Console,
...
class ThriveRichHandler(RichHandler):
    ...
    def emit(self, record: LogRecord) -> None:
        ...
        if (
            ...
            traceback = ThriveTraceback.from_exception(
                exc_type,
                exc_value,
                exc_traceback,
...
def init_logging(level: int) -> None:
    ...
    stdout_handler = ThriveRichHandler(
